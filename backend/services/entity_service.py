...
from backend.cosmos_client import create_item, read_item, upsert_item, delete_item, query_items
from backend.schema.validator import validate_and_apply_defaults
