...
Run with: python -m productivity_mcp.mcp_server
...
from productivity_mcp.tools.schema_tools import (
    create_entity_type_tool,
    get_user_schema_tool,
    update_entity_type_tool,
    delete_entity_type_tool,
)
from productivity_mcp.tools.entity_tools import (
    create_entity_tool,
    get_entity_tool,
    update_entity_tool,
    list_entities_tool,
...
logger.info("")
logger.info("Start with: uvicorn productivity_mcp.mcp_server:app --host 0.0.0.0 --port 8000")
logger.info("=" * 60)
